package com.github.ilcheese2.holders.dimension;
...
// From the fabric-dimension-example mod
public class HolderChunkGenerator extends ChunkGenerator {
    public static final Codec<HolderChunkGenerator> CODEC = RecordCodecBuilder.create((instance) -> method_41042(instance).and(RegistryOps.createRegistryCodec(Registry.BIOME_KEY).forGetter((generator) -> generator.biomeRegistry)).apply(instance, instance.stable(HolderChunkGenerator::new)));

    private final Registry<Biome> biomeRegistry;

    public HolderChunkGenerator(Registry<StructureSet> registry, Registry<Biome> biomeRegistry) {
